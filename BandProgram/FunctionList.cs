	...
	internal class FunctionList
	{
		...
		public bool login(string id, string pw, string type, bool logout = true)
		{
			...
			try
			{
				...
				{
					this.util.delayNext("[class='buttonRound -email']", 200);
					this.util.clickByCss("[class='buttonRound -email']", 500, 0);
				...
				{
					this.util.delayNext("[class='buttonRound -cellPhone']", 200);
					this.util.clickByCss("[class='buttonRound -cellPhone']", 500, 0);
				...
				{
					this.util.delayNext("[class*='buttonRound -naver externalLogin']", 200);
					this.util.clickByCss("[class*='buttonRound -naver externalLogin']", 500, 0);
